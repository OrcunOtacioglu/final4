...
fabric.Seat = new fabric.util.createClass(fabric.Circle, {
    ...
    initialize: function (options) {
         ...
         * 1    => Available            => Green | #46BE8A
         * 2    => Online Available     => Green | #46BE8A
         * 3    => Box Office Available => Orange | #46BE8A
         * 4    => Booked               => Purple | #F2A654
         * 5    => In Process           => Blue | #62A8EA
         * 6    => Sold                 => Red | #F96868
         */
        switch (this.status) {
            case '0':
            ...
            case '3':
                ...
                break;
            case '4':
                this.set('stroke', options.stroke || '#F2A654');
                this.set('fill', options.fill || '#F2A654');
                this.set('selectable', options.selectable || true);
                break;
            case '5':
                this.set('stroke', options.stroke || '#62A8EA');
                this.set('fill', options.fill || '#62A8EA');
                this.set('selectable', options.selectable || true);
                break;
            case '6':
                this.set('stroke', options.stroke || '#F96868');
                this.set('fill', options.fill || '#F96868');
                this.set('selectable', options.selectable || true);
                break;
            default:
        }
