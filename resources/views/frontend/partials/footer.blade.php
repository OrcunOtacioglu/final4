        ...
        <div class="row align-items-top text-center">
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 text-sm-left">
                ...
                <nav class="nav flex-column">
                    <a class="nav-link" href="https://www.froala.com">Terms & Conditions</a>
                    <a class="nav-link" href="https://www.froala.com">Disclaimer</a>
                    <a class="nav-link" href="https://www.froala.com">Cookies Policy</a>
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 mt-5 mt-sm-0 text-sm-left">
                ...
                <nav class="nav flex-column">
                    <a class="nav-link active" href="https://www.froala.com">About Us</a>
            ...
            <div class="col-12 col-lg-2 ml-auto text-lg-left mt-4 mt-lg-0">
                ...
                <p class="text-h3">
                    <a href="https://www.froala.com"><i class="ti-twitter-alt" aria-hidden="true"></i></a>&nbsp;&nbsp;
                    <a href="https://www.froala.com"><i class="ti-facebook" aria-hidden="true"></i></a>&nbsp;&nbsp;
                </p>
            </div>
        </div>
